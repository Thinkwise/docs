...
![Unit test overview](/website/blog/assets/2019_1_unit_test_overview.png)
...
![Unit test functionality](/website/blog/assets/2019_1_unit_test_functionality.png)
...
![Unit test execute](/website/blog/assets/2019_1_unit_test_execute.png)
...
* Added a *Process actions* tab page in the tasks and reports screens.
...
* The icons screen has been moved to the User Interface menu group. Here it has been made possible to alter multiple icons at once with a task.
* Templates in the *Available Templates* tab page under *Functionality* are no longer alphabetically sorted, but sorted by the order number of the templates.
