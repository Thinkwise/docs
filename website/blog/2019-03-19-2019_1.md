...
You can now determine the starting order of applications (runtime configurations) when starting Universal againts the Software Factory, without setting specific applications (runtime confirations).
...
* **Icon screen** - The icons screen has been moved to the User Interface list bar group. In here it has been made possible to alter multiple icons at once with a task.
