...
This also applies to the Windows and Web userinterfaces, which additionally need version 4.7.1 of the .NET Framework, and the Indicium application tier, which needs .NET 4.7.2 and .NET Core 2.1.5.
